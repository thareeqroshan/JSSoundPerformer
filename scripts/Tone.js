  ...
  (() => {
    ...
    return (
      (() => {
        ...
        const ts = ((t, e, s, n, i, o, r, a) =>
          ...
          kn = Js
            ? ((t, e, s, n, i, o, r, a, c, h, l, u, p, d) =>
                ...
                })(fn, Ve, Je, bn, wn, j, Tn, ke, De, Ie, 0, Sn, 0, ue)
            : void 0,
          An = ((t, e) => (s, n, i) => {
            if (null === e)
              throw new Error(
        ...
        class Di extends Ci {
          ...
          addAudioWorkletModule(t) {
            return ni(this, void 0, void 0, function* () {
              Bn(
                In(this.rawContext.audioWorklet),
        ...
        function Ni(t, e = !1) {
          e && Ii.dispose(), (Ii = ci(t) ? new Di(t) : ai(t) ? new qi(t) : t);
        }
        function Pi() {
          return Ii.resume();
        }
            ...
            return (
              Object.keys(t).forEach((e) => {
                if (Reflect.has(this, e)) {
                  const s = this[e];
                  In(s) && In(s.value) && In(s.setValueAtTime)
                    ? (t[e] = s.value)
                    : s instanceof eo
          ...
          set(t) {
            return (
              Object.keys(t).forEach((e) => {
                Reflect.has(this, e) &&
                  In(this[e]) &&
                  (this[e] && In(this[e].value) && In(this[e].setValueAtTime)
        ...
        class no extends eo {
          constructor() {
            super(
              ui(no.getDefaults(), arguments, ["param", "units", "convert"])
            ),
              (this.name = "Param"),
              (this.overridden = !1),
            ...
            for (
              Bn(
                In(t.param) && (oi(t.param) || t.param instanceof no),
        ...
        function ro(t, e, s = 0, n = 0) {
          for (
            Bn(In(t), "Cannot connect from undefined node"),
              Bn(In(e), "Cannot connect to undefined node"),
        ...
        class ho extends io {
          constructor() {
            super(ui(ho.getDefaults(), arguments, ["gain", "units"])),
              (this.name = "Gain"),
        ...
        class uo extends lo {
          constructor() {
            super(ui(uo.getDefaults(), arguments, ["offset"])),
        ...
        class po extends io {
          constructor() {
            super(ui(po.getDefaults(), arguments, ["value", "units"])),
              (this.name = "Signal"),
              (this.override = !0);
        ...
        class _o extends no {
          constructor() {
            super(ui(_o.getDefaults(), arguments, ["value"])),
              (this.name = "TickParam"),
        ...
        class mo extends po {
          constructor() {
            super(ui(mo.getDefaults(), arguments, ["value"])),
        ...
        class go extends eo {
          constructor() {
            super(ui(go.getDefaults(), arguments, ["frequency"])),
        ...
        class vo extends eo {
          constructor() {
            super(ui(vo.getDefaults(), arguments, ["callback", "frequency"])),
              (this.name = "Clock"),
              (this.callback = Ei),
              (this._lastUpdate = 0),
        ...
        class yo extends io {
          constructor() {
            super(ui(yo.getDefaults(), arguments, ["delayTime", "maxDelay"])),
              (this.name = "Delay");
        ...
        class Oo extends io {
          constructor() {
            super(ui(Oo.getDefaults(), arguments, ["volume"])),
              (this.name = "Volume");
        ...
        class Mo extends io {
          constructor() {
            super(ui(Mo.getDefaults(), arguments)),
              ...
              (this.input = new Oo({ context: this.context })),
        ...
        Ti((t) => {
          t.destination = new Mo({ context: t });
        }),
          ki((t) => {
        ...
        class qo extends Ro {
          constructor() {
            super(
              Object.assign(
                ui(qo.getDefaults(), arguments, ["mapping", "length"])
              )
            ),
        ...
        class Fo extends Ro {
          constructor() {
            super(Object.assign(ui(Fo.getDefaults(), arguments, ["value"]))),
              (this.name = "Pow");
          ...
          _createEvent() {
            return vi(this._nextTick, this.floatTime + this.duration)
              ? this.transport.scheduleOnce(
                  ...
                  new So(this.context, this._nextTick).toSeconds()
                )
              : -1;
          }
          _createEvents(t) {
        ...
        class No extends eo {
          ...
          _processTick(t, e) {
            if (
              ...
              t +=
                new So(this.context, (2 * this._swingTicks) / 3).toSeconds() *
                n;
            }
        ...
        class Po extends io {
          ...
          stop(t) {
            ...
            if (
              ...
              "started" === this._state.getValueAtTime(e) ||
                In(this._state.getNextState("started", e)))
            ) {
        ...
        class jo extends lo {
          constructor() {
            super(ui(jo.getDefaults(), arguments, ["url", "onload"])),
              (this.name = "ToneBufferSource"),
              (this._source = this.context.createBufferSource()),
              (this._internalChannels = [this._source]),
              (this._sourceStarted = !1),
              (this._sourceStopped = !1);
            const t = ui(jo.getDefaults(), arguments, ["url", "onload"]);
            ro(this._source, this._gainNode),
        ...
        class Lo extends Po {
          constructor() {
            super(ui(Lo.getDefaults(), arguments, ["type"])),
              (this.name = "Noise"),
              (this._source = null);
            const t = ui(Lo.getDefaults(), arguments, ["type"]);
          ...
          set type(t) {
            if (
              (Bn(t in Bo, "Noise: invalid type: " + t),
        ...
        const zo = 220500,
          Wo = { brown: null, pink: null, white: null },
          Bo = {
            get brown() {
              if (!Wo.brown) {
                const t = [];
        ...
        class Uo extends io {
          constructor() {
            super(ui(Uo.getDefaults(), arguments, ["volume"])),
              (this.name = "UserMedia");
            const t = ui(Uo.getDefaults(), arguments, ["volume"]);
            (this._volume = this.output =
              new Oo({ context: this.context, volume: t.volume })),
              (this.volume = this._volume.volume),
              Oi(this, "volume"),
              (this.mute = t.mute);
          }
            ...
            return ni(this, void 0, void 0, function* () {
              ...
              Nn(t)
                ...
                : ((this._device = e.find(
                  ...
                  Bn(In(this._device), `No matching device ${t}`));
              const s = {
                audio: {
                  echoCancellation: !1,
          ...
          static get supported() {
            return (
              ...
              In(navigator.mediaDevices.getUserMedia)
            );
          }
        }
        function Go(t, e) {
        ...
        class Qo extends lo {
          constructor() {
            super(ui(Qo.getDefaults(), arguments, ["frequency", "type"])),
              (this.name = "ToneOscillatorNode"),
              (this._oscillator = this.context.createOscillator()),
              (this._internalChannels = [this._oscillator]);
            const t = ui(Qo.getDefaults(), arguments, ["frequency", "type"]);
        ...
        class Zo extends Po {
          constructor() {
            super(ui(Zo.getDefaults(), arguments, ["frequency", "type"])),
          ...
          _getCachedPeriodicWave() {
            if ("custom" === this._type)
              return Zo._periodicWaveCache.find((t) => {
                return (
                  t.phase === this._phase &&
                  ((e = t.partials),
                  (s = this._partials),
            ...
            {
              const t = Zo._periodicWaveCache.find(
            ...
            if (0 === this._phase && e)
              ...
              if (In(e)) {
                ...
                (this._wave = n),
                  ...
                  Zo._periodicWaveCache.length > 100 &&
                    Zo._periodicWaveCache.shift();
              }
            }
          }
          get baseType() {
        ...
        class Yo extends po {
          constructor() {
            super(Object.assign(ui(Yo.getDefaults(), arguments, ["value"]))),
              (this.name = "Multiply"),
              (this.override = !1);
            const t = ui(Yo.getDefaults(), arguments, ["value"]);
            (this._mult =
              this.input =
              this.output =
                new ho({
        ...
        class $o extends Po {
          constructor() {
            super(
              ...
              (this._modulationScale = new Xo({ context: this.context })),
            ...
            (this._carrier = new Zo({
              ...
              Oi(this, ["frequency", "detune", "harmonicity"]);
          }
          static getDefaults() {
        ...
        class Jo extends Po {
          constructor() {
            super(ui(Jo.getDefaults(), arguments, ["frequency", "width"])),
            ...
            const t = ui(Jo.getDefaults(), arguments, ["frequency", "width"]);
            (this.width = new po({
              context: this.context,
              units: "audioRange",
              value: t.width,
              ...
              Oi(this, ["width", "frequency", "detune"]);
          }
          static getDefaults() {
            return Object.assign(Po.getDefaults(), {
              detune: 0,
        ...
        class Ko extends Po {
          constructor() {
            super(
              ui(Ko.getDefaults(), arguments, ["frequency", "type", "spread"])
            ),
        ...
        class tr extends Po {
          constructor() {
            super(
              ...
              (this.sourceType = "pwm"),
              (this._scale = new Yo({ context: this.context, value: 2 }));
            ...
            (this._pulse = new Jo({
              ...
              Oi(this, ["modulationFrequency", "frequency", "detune"]);
          }
          static getDefaults() {
            return Object.assign(Po.getDefaults(), {
              detune: 0,
        ...
        class sr extends Po {
          constructor() {
            super(ui(sr.getDefaults(), arguments, ["frequency", "type"])),
              (this.name = "OmniOscillator");
            const t = ui(sr.getDefaults(), arguments, ["frequency", "type"]);
            (this.frequency = new po({
              context: this.context,
              units: "frequency",
              value: t.frequency,
        ...
        class nr extends po {
          constructor() {
            super(Object.assign(ui(nr.getDefaults(), arguments, ["value"]))),
              (this.override = !1),
              (this.name = "Add"),
        ...
        class ir extends Ro {
          constructor() {
            super(
              Object.assign(ui(ir.getDefaults(), arguments, ["min", "max"]))
            ),
              (this.name = "Scale");
            const t = ui(ir.getDefaults(), arguments, ["min", "max"]);
            (this._mult = this.input =
              new Yo({ context: this.context, value: t.max - t.min })),
              (this._add = this.output =
                new nr({ context: this.context, value: t.min })),
              (this._min = t.min),
              (this._max = t.max),
        ...
        class rr extends io {
          constructor() {
            super(ui(rr.getDefaults(), arguments, ["frequency", "min", "max"])),
              (this.name = "LFO"),
            ...
            (this._oscillator = new Zo(t)),
              ...
              (this._zeros = new or({ context: this.context })),
              (this._a2g = new Xo({ context: this.context })),
              (this._scaler = this.output =
                new ir({ context: this.context, max: t.max, min: t.min })),
              (this.units = t.units),
              (this.min = t.min),
              (this.max = t.max),
        ...
        class hr extends Po {
          constructor() {
            super(ui(hr.getDefaults(), arguments, ["url", "onload"])),
              (this.name = "Player"),
              (this._activeSources = new Set());
            const t = ui(hr.getDefaults(), arguments, ["url", "onload"]);
            (this._buffer = new Ri({
        ...
        class lr extends io {
          constructor() {
            super(ui(lr.getDefaults(), arguments, ["urls", "onload"], "urls")),
              (this.name = "Players"),
              (this.input = void 0),
        ...
        class ur extends Po {
          constructor() {
            super(ui(ur.getDefaults(), arguments, ["url", "onload"])),
              (this.name = "GrainPlayer"),
              (this._loopStart = 0),
              (this._loopEnd = 0),
              (this._activeSources = []);
            const t = ui(ur.getDefaults(), arguments, ["url", "onload"]);
            (this.buffer = new Ri({
              onload: t.onload,
              onerror: t.onerror,
              reverse: t.reverse,
        ...
        class fr extends Ro {
          constructor() {
            super(...arguments),
              (this.name = "Negate"),
              (this._multiply = new Yo({ context: this.context, value: -1 })),
        ...
        class _r extends po {
          constructor() {
            super(Object.assign(ui(_r.getDefaults(), arguments, ["value"]))),
              (this.override = !1),
              (this.name = "Subtract"),
              (this._sum = new ho({ context: this.context })),
              (this.input = this._sum),
              (this.output = this._sum),
              (this._neg = new fr({ context: this.context })),
          ...
          constructor() {
            super(Object.assign(ui(mr.getDefaults(), arguments))),
              ...
              (this._scale = this.input =
                new Yo({ context: this.context, value: 1e4 })),
        ...
        class gr extends po {
          constructor() {
            super(Object.assign(ui(gr.getDefaults(), arguments, ["value"]))),
              (this.name = "GreaterThan"),
              (this.override = !1);
            const t = ui(gr.getDefaults(), arguments, ["value"]);
            (this._subtract = this.input =
              new _r({ context: this.context, value: t.value })),
              (this._gtz = this.output = new mr({ context: this.context })),
        ...
        class vr extends ir {
          constructor() {
            super(
              Object.assign(
                ui(vr.getDefaults(), arguments, ["min", "max", "exponent"])
              )
            ),
              (this.name = "ScaleExp");
        ...
        class kr extends Tr {
          constructor() {
            ...
            (this.oscillator = new sr(
              ...
              (this.envelope = new Sr(
                Object.assign({ context: this.context }, t.envelope)
              )),
              this.oscillator.chain(this.envelope, this.output),
              Oi(this, ["oscillator", "frequency", "detune", "envelope"]);
          }
          static getDefaults() {
            return Object.assign(Tr.getDefaults(), {
              envelope: Object.assign(
                di(xr.getDefaults(), Object.keys(io.getDefaults())),
        ...
        class Dr extends io {
          constructor() {
            super(ui(Dr.getDefaults(), arguments, ["frequency", "type"])),
        ...
        class Or extends io {
          constructor() {
            super(
              ui(Or.getDefaults(), arguments, ["frequency", "type", "rolloff"])
            ),
              (this.name = "Filter"),
            ...
            (this._filters = []),
              ...
              Oi(this, ["detune", "frequency", "gain", "Q"]);
          }
          static getDefaults() {
            return Object.assign(io.getDefaults(), {
              Q: 1,
          ...
          static getDefaults() {
            return Object.assign(Tr.getDefaults(), {
              ...
              filter: Object.assign(
                di(Or.getDefaults(), Object.keys(io.getDefaults())),
              ...
              oscillator: Object.assign(
                di(sr.getDefaults(), Object.keys(Po.getDefaults())),
                { type: "sawtooth" }
              ),
            });
          }
        ...
        class Ir extends Tr {
          constructor() {
            ...
            for (let e = 0; e < Fr.length; e++) {
              ...
              const n = new Yo({ context: this.context, value: Fr[e] });
        ...
        class Nr extends br {
          ...
          static getDefaults() {
            return Object.assign(br.getDefaults(), {
              ...
              noise: Object.assign(
                di(Lo.getDefaults(), Object.keys(Po.getDefaults())),
                { type: "white" }
              ),
            });
          }
        ...
        class Br extends zr {
          constructor() {
            super(ui(Br.getDefaults(), arguments, ["delayTime", "resonance"])),
        ...
        class Ur extends io {
          constructor() {
            super(ui(Ur.getDefaults(), arguments, ["frequency", "type"])),
        ...
        class Qr extends br {
          constructor() {
            ...
            const t = ui(Qr.getDefaults(), arguments);
            (this._noise = new Lo({ context: this.context, type: "pink" })),
        ...
        class Zr extends br {
          constructor() {
            super(ui(Zr.getDefaults(), arguments, ["voice", "options"])),
              (this.name = "PolySynth"),
          ...
          _getNextAvailableVoice() {
            ...
            if (this._voices.length < this.maxPolyphony) {
              ...
              return (
                Bn(t instanceof Tr, "Voice must extend Monophonic class"),
        ...
        class Yr extends eo {
          constructor() {
            super(ui(Yr.getDefaults(), arguments, ["callback", "value"])),
              (this.name = "ToneEvent"),
              (this._state = new so("stopped")),
              (this._startOffset = 0);
        ...
        class $r extends eo {
          constructor() {
            super(ui($r.getDefaults(), arguments, ["callback", "interval"])),
              (this.name = "Loop");
        ...
        class Hr extends Yr {
          constructor() {
            super(ui(Hr.getDefaults(), arguments, ["callback", "events"])),
              (this.name = "Part"),
              (this._state = new so("stopped")),
              ...
              this._loop
                ? t.startOffset >= this._loopStart &&
                  ...
                  ? (t.startOffset < s && (e += this._getLoopDuration()),
                    t.start(new So(this.context, e)))
                  : t.startOffset < this._loopStart &&
                    t.startOffset >= s &&
                    ((t.loop = !1), t.start(new So(this.context, e)))
                : t.startOffset >= s && t.start(new So(this.context, e));
          }
          get startOffset() {
            return this._startOffset;
          }
          ...
          _restartEvent(t) {
            this._state.forEach((e) => {
              "started" === e.state
                ...
                : t.stop(new So(this.context, e.time));
            });
          }
          remove(t, e) {
            return (
        ...
        class ra extends $r {
          constructor() {
            super(
              ui(ra.getDefaults(), arguments, ["callback", "values", "pattern"])
            ),
              (this.name = "Pattern");
        ...
        class aa extends Yr {
          ...
          static getDefaults() {
            return Object.assign(di(Yr.getDefaults(), ["value"]), {
              events: [],
              loop: !0,
              loopEnd: 0,
              loopStart: 0,
        ...
        class ca extends io {
          constructor() {
            super(Object.assign(ui(ca.getDefaults(), arguments, ["fade"]))),
              (this.name = "CrossFade"),
              (this._panner = this.context.createStereoPanner()),
              (this._split = this.context.createChannelSplitter(2)),
              (this._g2a = new dr({ context: this.context })),
        ...
        class ha extends io {
          constructor(t) {
            super(t),
              (this.name = "Effect"),
              (this._dryWet = new ca({ context: this.context })),
        ...
        class pa extends io {
          constructor() {
            super(Object.assign(ui(pa.getDefaults(), arguments, ["pan"]))),
              (this.name = "Panner"),
              (this._panner = this.context.createStereoPanner()),
        ...
        class da extends la {
          constructor() {
            super(ui(da.getDefaults(), arguments, ["frequency"])),
        ...
        class fa extends io {
          constructor() {
            super(ui(fa.getDefaults(), arguments, ["smoothing"])),
              (this.name = "Follower");
            const t = ui(fa.getDefaults(), arguments, ["smoothing"]);
            (this._abs = this.input = new pr({ context: this.context })),
        ...
        class ga extends ha {
          constructor() {
            super(ui(ga.getDefaults(), arguments, ["bits"])),
        ...
        class ya extends ha {
          constructor() {
            super(ui(ya.getDefaults(), arguments, ["order"])),
              (this.name = "Chebyshev");
            const t = ui(ya.getDefaults(), arguments, ["order"]);
            (this._shaper = new qo({ context: this.context, length: 4096 })),
              (this._order = t.order),
        ...
        class xa extends io {
          constructor() {
            super(ui(xa.getDefaults(), arguments, ["channels"])),
              (this.name = "Split");
        ...
        class wa extends io {
          constructor() {
            super(ui(wa.getDefaults(), arguments, ["channels"])),
              (this.name = "Merge");
          ...
          constructor(t) {
            super(t),
              ...
              (this._dryWet = this.output =
                new ca({ context: this.context, fade: t.wet })),
              (this.wet = this._dryWet.fade),
              (this._split = new xa({ context: this.context, channels: 2 })),
              (this._merge = new wa({ context: this.context, channels: 2 })),
        ...
        class ka extends ha {
          constructor() {
            super(ui(ka.getDefaults(), arguments, ["distortion"])),
        ...
        class Ca extends Aa {
          constructor() {
            super(ui(Ca.getDefaults(), arguments, ["delayTime", "feedback"])),
        ...
        class Oa extends ha {
          constructor() {
            super(ui(Oa.getDefaults(), arguments, ["frequency"])),
            ...
            (this.frequency = new po({
              ...
              (this._sine = new Qo({ context: this.context, type: "sine" })),
              (this._cosine = new Zo({
                context: this.context,
                phase: -90,
                type: "sine",
              })),
              (this._sineMultiply = new Yo({ context: this.context })),
              (this._cosineMultiply = new Yo({ context: this.context })),
              (this._negate = new fr({ context: this.context })),
              (this._add = new nr({ context: this.context })),
        ...
        class Ra extends ba {
          constructor() {
            super(ui(Ra.getDefaults(), arguments, ["roomSize", "dampening"])),
              (this.name = "Freeverb"),
              (this._combFilters = []),
        ...
        class Va extends ba {
          constructor() {
            super(ui(Va.getDefaults(), arguments, ["roomSize"])),
              (this.name = "JCReverb"),
            ...
            (this.roomSize = new po({
              ...
              (this._feedbackCombFilters = qa.map((t, e) => {
                const s = new Br({ context: this.context, delayTime: t });
                return (
        ...
        class Pa extends Na {
          constructor() {
            super(ui(Pa.getDefaults(), arguments, ["delayTime", "feedback"])),
        ...
        class ja extends Aa {
          constructor() {
            super(ui(ja.getDefaults(), arguments, ["pitch"])),
            ...
            (this._frequency = new po({ context: this.context })),
              ...
              (this._crossFade = new ca({ context: this.context })),
        ...
        class za extends ha {
          constructor() {
            super(ui(za.getDefaults(), arguments, ["decay"])),
              (this.name = "Reverb"),
          ...
          constructor() {
            super(ui(Wa.getDefaults(), arguments)),
              ...
              (this._split = this.input =
                new xa({ channels: 2, context: this.context })),
              (this._midAdd = new nr({ context: this.context })),
              (this.mid = new Yo({
                context: this.context,
                value: Math.SQRT1_2,
              })),
              (this._sideSubtract = new _r({ context: this.context })),
              (this.side = new Yo({
                context: this.context,
                value: Math.SQRT1_2,
              })),
        ...
        class Ba extends io {
          constructor() {
            super(ui(Ba.getDefaults(), arguments)),
              ...
              (this._left = new nr({ context: this.context })),
              (this._leftMult = new Yo({
                context: this.context,
                value: Math.SQRT1_2,
              })),
              (this._right = new _r({ context: this.context })),
              (this._rightMult = new Yo({
                context: this.context,
                value: Math.SQRT1_2,
              })),
              (this._merge = this.output = new wa({ context: this.context })),
        ...
        class Ua extends ha {
          constructor(t) {
            super(t),
              ...
              (this._midSideMerge = new Ba({ context: this.context })),
              (this._midSideSplit = new Wa({ context: this.context })),
        ...
        class Ga extends Ua {
          constructor() {
            super(ui(Ga.getDefaults(), arguments, ["width"])),
            ...
            (this.width = new po({
              ...
              (this._midMult = new Yo({ context: this.context })),
              this._twoTimesWidthMid.connect(this._midMult.factor),
              this.connectEffectMid(this._midMult),
              (this._oneMinusWidth = new _r({ context: this.context })),
              this._oneMinusWidth.connect(this._twoTimesWidthMid),
              ro(this.context.getConstant(1), this._oneMinusWidth),
              this.width.connect(this._oneMinusWidth.subtrahend),
              (this._sideMult = new Yo({ context: this.context })),
        ...
        class Qa extends ba {
          constructor() {
            super(ui(Qa.getDefaults(), arguments, ["frequency", "depth"])),
              (this.name = "Tremolo");
        ...
        class Za extends ha {
          constructor() {
            super(ui(Za.getDefaults(), arguments, ["frequency", "depth"])),
              (this.name = "Vibrato");
        ...
        class Xa extends io {
          constructor() {
            super(ui(Xa.getDefaults(), arguments, ["type", "size"])),
              (this.name = "Analyser"),
              (this._analysers = []),
              (this._buffers = []);
        ...
        class $a extends Ya {
          constructor() {
            super(ui($a.getDefaults(), arguments, ["smoothing"])),
              (this.name = "Meter");
        ...
        class Ha extends Ya {
          constructor() {
            super(ui(Ha.getDefaults(), arguments, ["size"])),
              (this.name = "FFT");
        ...
        class Ka extends Ya {
          constructor() {
            super(ui(Ka.getDefaults(), arguments, ["size"])),
              (this.name = "Waveform");
        ...
        class tc extends io {
          constructor() {
            super(ui(tc.getDefaults(), arguments, ["solo"])),
              (this.name = "Solo");
            const t = ui(tc.getDefaults(), arguments, ["solo"]);
            (this.input = this.output = new ho({ context: this.context })),
              tc._allSolos.has(this.context) ||
                tc._allSolos.set(this.context, new Set()),
          ...
          _addSolo() {
            tc._soloed.has(this.context) ||
              tc._soloed.set(this.context, new Set()),
              tc._soloed.get(this.context).add(this);
          }
          _removeSolo() {
            tc._soloed.has(this.context) &&
              tc._soloed.get(this.context).delete(this);
          }
          _isSoloed() {
            return (
              tc._soloed.has(this.context) &&
              tc._soloed.get(this.context).has(this)
            );
          }
          _noSolos() {
            return (
        ...
        class ec extends io {
          constructor() {
            super(ui(ec.getDefaults(), arguments, ["pan", "volume"])),
              (this.name = "PanVol");
        ...
        class sc extends io {
          constructor() {
            super(ui(sc.getDefaults(), arguments, ["volume", "pan"])),
              (this.name = "Channel");
            const t = ui(sc.getDefaults(), arguments, ["volume", "pan"]);
            (this._solo = this.input =
              new tc({ solo: t.solo, context: this.context })),
          ...
          _getBus(t) {
            return (
              sc.buses.has(t) ||
                sc.buses.set(t, new ho({ context: this.context })),
              sc.buses.get(t)
            );
          }
          send(t, e = 0) {
        ...
        class ic extends io {
          constructor() {
            super(
              ui(ic.getDefaults(), arguments, ["lowFrequency", "highFrequency"])
            ),
            ...
            (this.lowFrequency = new po({
              ...
              Oi(this, ["high", "mid", "low", "highFrequency", "lowFrequency"]);
          }
          static getDefaults() {
            return Object.assign(io.getDefaults(), {
              Q: 1,
        ...
        class cc extends io {
          constructor() {
            super(ui(cc.getDefaults(), arguments, ["threshold", "ratio"])),
        ...
        class hc extends io {
          constructor() {
            super(
              Object.assign(
                ui(hc.getDefaults(), arguments, ["threshold", "smoothing"])
              )
            ),
              (this.name = "Gate");
        ...
        class lc extends io {
          constructor() {
            super(
              Object.assign(ui(lc.getDefaults(), arguments, ["threshold"]))
            ),
              (this.name = "Limiter");
        ...
        class dc extends io {
          constructor() {
            super(ui(dc.getDefaults(), arguments, ["low", "mid", "high"])),
              (this.name = "EQ3"),
              (this.output = new ho({ context: this.context })),
              (this._internalChannels = []);
            ...
            (this.input = this._multibandSplit =
              ...
              Oi(this, ["low", "mid", "high", "lowFrequency", "highFrequency"]),
        ...
        class fc extends io {
          constructor() {
            super(ui(fc.getDefaults(), arguments, ["url", "onload"])),
              (this.name = "Convolver"),
              (this._convolver = this.context.createConvolver());
